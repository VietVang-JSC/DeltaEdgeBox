...
class SyncTransformer
{
    ...
    private static function transformProductToBackend(array $data): array
    {
        return [
            ...
            'second_product_code' => $data['second_product_code'] ?? null,
            'third_product_code' => $data['third_product_code'] ?? null,
            'parent_id' => null,
            'type_id' => $data['type_id'] ?? null,
            'is_extra' => $data['is_extra'] ?? false,
            'is_combo' => $data['is_combo'] ?? false,
            'number_of_options' => $data['number_of_options'] ?? null,
            'vat' => $data['vat'] ?? 0,
            'check' => $data['check'] ?? 0,
            'title' => $data['name'],
            'min_quantity' => $data['min_quantity'] ?? null,
            'price' => $data['price'],
            'price_after_tax' => $data['price_after_tax'] ?? $data['price'],
            'status' => (int) ($data['status'] ?? 1),
            'inventory_required' => $data['inventory_required'] ?? false,
            'type_final_product' => $data['type_final_product'] ?? true,
            'type_commodity' => $data['type_commodity'] ?? false,
            'image' => $data['image'] ?? '',
            'admin_id' => $data['admin_id'],
            ...
            'unit' => $data['unit'] ?? 1,
            'store_id' => $data['store_id'] ?? null,
            'is_ingredient' => $data['is_ingredient'] ?? false,
            'print_id' => $data['print_id'] ?? null,
            'sort_rank' => $data['sort_rank'] ?? 0,
    ...
    private static function transformProductToEdgeBox(array $data): array
    {
        return [
            ...
            'category_id' => $data['category_id'] ?? null,
            'store_id' => $data['store_id'] ?? null,
            'is_restricted_time' => $data['is_restricted_time'] ?? false,
            'vat' => $data['vat'] ?? 0,
            'price_after_tax' => $data['price_after_tax'] ?? $data['price'] ?? 0,
            ...
            'type_id' => $data['type_id'] ?? null,
            'inventory_required' => $data['inventory_required'] ?? false,
            'number_of_options' => $data['number_of_options'] ?? 0,
            'is_ingredient' => $data['is_ingredient'] ?? false,
            'print_id' => $data['print_id'] ?? null,
            'sort_rank' => $data['sort_rank'] ?? 0,
            'is_show' => $data['is_show'] ?? 1,
    ...
    private static function transformPaymentToBackend(array $data, array $details = []): array
    {
        ...
        return [
            ...
            'valuetotal' => $data['final_total'] ?? $data['total'],
            'discount' => $data['discount'] ?? 0,
            'surcharge' => $data['surcharge'] ?? 0,
            'surcharge_reason' => $data['surcharge_reason'] ?? null,
            'surcharge_percent' => $data['surcharge_percent'] ?? 0,
            'service_charge' => $data['service_charge'] ?? 0,
            'service_charge_amount' => $data['service_charge_amount'] ?? 0,
            'total_tax' => $data['tax'] ?? 0,
            'amount_received' => $data['amount_received'] ?? $data['final_total'] ?? $data['total'],
    ...
    private static function transformPaymentToEdgeBox(array $data): array
    {
        return [
            ...
            'amount_received' => $data['amount_received'] ?? $data['valuetotal'],
            'payment_method' => $data['payment_method'] ?? 'cash',
            'note' => $data['note'] ?? null,
            'status' => $data['status'],
            'user_id' => $data['user_id'],
    ...
    private static function transformPaymentDetailToBackend(array $data): array
    {
        return [
            ...
            'note' => $data['note'] ?? null,
            'product_extra' => $data['product_extra'] ?? null,
            'optional_products' => $data['optional_products'] ?? null,
            'inventory_histories' => $data['inventory_histories'] ?? null,
            'input_code' => $data['input_code'] ?? null,
            'admin_id' => $data['admin_id'] ?? 1,
            'store_id' => $data['store_id'] ?? null,
            'delete_note' => $data['delete_note'] ?? null,
            'detail_discount' => $data['detail_discount'] ?? 0,
            'served' => $data['served'] ?? false,
            'tax_amount' => $data['tax_amount'] ?? 0,
            'detail_discount_excluding_tax' => $data['detail_discount_excluding_tax'] ?? 0,
            'unit_price_excluding_tax' => $data['unit_price_excluding_tax'] ?? 0,
            'discounted_price_excluding_tax' => $data['discounted_price_excluding_tax'] ?? 0,
            'printed_quantity' => $data['printed_quantity'] ?? 0,
            'created_at' => $data['created_at'] ?? null,
            'updated_at' => $data['updated_at'] ?? null,
        ];
    }
